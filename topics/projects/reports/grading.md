...
**Grader:** Prof. Dr. Huber / Mr. Gross  

---

**Grading scale:** 1.0 (best) · 1.3 · 1.7 · 2.0 · 2.3 · 2.7 · 3.0 · 3.3 · 3.7 · 4.0 · 5.0 (failed)

---

## Group 1 — Athina Agiakatsikas & Stella Christou

**Report:** *What Drives Engagement on YouTube? A Data-Driven Analysis of Influencer Metrics*  
**File:** `Athina Stella/Data Science Report Athina Stella.html`  
**Word count:** ~6,081
...
> Both authors contributed roughly equally (see Division of Work table). No quality difference justifies separate grades.

---

## Group 2 — Dominic Walde

**Report:** *Player Market Valuation: A Regression Analysis of Performance Metrics in Elite Football*  
**File:** `Dominic/_site/index.html`  
**Student ID:** 400913882
...
> This is a solo report. Statistical methods are appropriate, but the overly AI-dependent writing style and lack of reported numerical results in the discussion justify the grade.

---

## Group 3 — Mira Heinemann & Esra Tonleu

**Report:** *The Effect of Elon Musk's Tweets on Tesla's Stock Market Performance*  
**File:** `Esra Mira/Data_Science_Data_Analytics_Final_Report_Heinemann_Tonleu.html`  
**Word count:** ~9,830
...
> Author contributions are not broken down by section, and the quality is consistently high throughout. Both authors receive the same grade.

---

## Group 4 — Leonie Wegeler, Jill Safarli & Isabel Vilela Wetz

**Report:** *An Empirical Analysis of Danceability and Energy as Predictors of Song Popularity on Spotify*  
**File:** `Jill Leonie Isabel/Data_Science_and_Data_Analytics_Jill_Safarli_Prof._Dr._Huber_a_Mr._Gross.html`
...
> Individual sections are attributed (Leonie Wegeler: Section 1.1 and parts of 1.2; Isabel Vilela Wetz: Section 1.2). The quality is consistently strong across all attributed sections. No individual grade difference is warranted.

---

## Group 5 — Eric Wolff, Mats Biermann & Laurine Fleck
...
**File:** `Laurine Mats Eric/Report_Data_Science_and_ Data_Analytics_Eric_Wolff_Laurine_Fleck_Mats_Biermann_Huber_Gross/Report_Data_Science_and_ Data_Analytics_Eric_Wolff_Laurine_Fleck_Mats_Biermann_Huber_Gross.html`  
**Word count:** ~12,484
...
> Contributions are well-distributed and of similar quality. The methodological ambition (Granger causality, stationarity testing) is noted positively. Minor language issues and inconsistent depth in results reporting prevent a higher grade.
...
| 2 | Dominic Walde | Football player valuation (regression) | adequate | low | weak | problematic | **2.7** |
