...
and data catalog platforms (e.g., Alation, Collibra) operationalize data management 
practices. Also the [n8n](https://n8n.io/) automation tool can be used for automating data workflows. 
