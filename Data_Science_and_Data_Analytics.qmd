...
# Performing factor analysis (if we have enough observations)
if(nrow(df_wide_fa) > 10) {
  fa_result <- fa(df_wide_fa, nfactors = 2, rotate = "varimax")
...
- Project *COVID-19 pandemic* (Mats, Laurine, Eric): Week 50 (10.12.2025)
- Project *Influencer Engagement* (Stella, Athina): Week 50 (10.12.2025)
- Project *Elon Musk* (Esra, Mira): Week 51 (17.12.2025)
- Project *??* (Jamder): Week 51 (17.12.2025)  
