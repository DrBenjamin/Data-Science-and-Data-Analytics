...
* **Mathematics (linear algebra, calculus, optimization):**
  ...
  ![**Source:** *LinkedIn*](./topics/Scope%20and%20Nature%20of%20Data%20Science/AI_Models.png)
...
```{r r_continuous, results='asis', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r r_count, results='asis', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
# Assigning count data to a data frame and displaying it as a table
count_data <- data.frame(
  Event = c("A", "B", "C", "D", "E"),
  Frequency = c(5, 10, 3, 8, 12)
)
...
```{r r_ordinal, results='asis', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r r_categorical, results='asis', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
```{r r_compositional, results='asis', echo=TRUE, message=FALSE, warning=FALSE, error=FALSE}
...
hierarchical_data <- data.frame(
  ...
  State_Province = c("California", "Texas", "Ontario", "Quebec", "Jalisco"),
  Population_Millions = c(39.5, 29.0, 14.5, 8.5, 8.3)
)
