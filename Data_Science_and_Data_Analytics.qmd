...
Emerging trends in cloud-native data platforms, ETL/ELT (Extract, Transform,
Load or Extract, Load, Transform), data lakes/lakehouses, and broader metadata
automation shape scalable storage/compute and governance, enabling reproducible analytics
and ML workflows. Together, these strands underpin trustworthy, discoverable,
...
Tools like [dbt](https://www.getdbt.com/), [Apache Airflow](https://airflow.apache.org),
and data catalog platforms (e.g., [Alation](https://www.alation.com), [Collibra](https://www.collibra.com)) operationalize data management practices.
Also the [n8n](https://n8n.io/) automation tool can be used for automating data workflows. 
See the [Analytical Skills for Business course handbook](https://drbenjamin.github.io/analytical-skills.html#overview-on-no-code-and-low-code-tools-for-data-analytics) on this topic. In late
2025 there was a free [n8n certification course](https://docs.n8n.io/courses/level-one/)
added to the n8n documentation.
...
You will find all formal instructions for the project report and presentation in the [guidelines](./topics/projects/dsda_guidelines_ws2526.pdf).
